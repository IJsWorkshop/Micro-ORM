...
//static List<string> GetMapOrder(this string mappingSource)
...
//static List<Type> GetActiveClassFromAssembly()
//{
//    var activeClassList = new List<Type>();

//    // Get assembly types we are after
//    var types = Assembly.GetExecutingAssembly().GetTypes();

//    // collect types we are interested in
